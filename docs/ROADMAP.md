...
| 캐릭터 선택·교체(WP-18, D-018 ① 승인): **설계 완료**, 18a 템플릿4종 로스터·콘솔·동일 폰은 스택 PR #23에서 구현/검증. 18b 최종 에셋·리타깃은 V-08/V-12·② 뒤, UI/선택 저장·커스터마이즈는 Phase2 초반 WP-15와 함께. [설계·리뷰](plan/WP-18-characters.md) | 기본 조작을 보존하고 V-11 교체/포털/사진 검증. V-12는 구성별 필수 조명·배경을 채점하며 최종 화면 품질은 별도 판정 |

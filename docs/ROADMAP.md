...
| 캐릭터 선택·교체(WP-18, D-018 ① 승인): **🟡 설계·18a 코드 완료, GUI 대기**. 템플릿4종 JSON 로스터·`golmok.character`·동일 폰 교체, 실제 포털 왕복 포함UE19 Success. 18b 최종 에셋·리타깃은 V-08/V-12·② 뒤, UI/선택 저장·커스터마이즈는 Phase2 초반 WP-15와 함께. [설계·리뷰](plan/WP-18-characters.md)·[V-11](runbooks/pc-verify-wp18a.md) | 기본 조작180/500cm/s 보존. V-11 GUI/사진·성능 대기. V-12는 구성별 필수 조명·배경을 채점하며 최종 화면 품질은 별도 판정 |

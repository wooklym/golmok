...
| # | 작업 | 담당 | 완료 기준 |
|---|---|---|---|
| 1.0a | **사용자 Windows PC 사양 확인**(CPU, RAM, GPU, 저장공간) → 필요하면 업그레이드. 툴 설치: UE 5.8.3, VS 2026, Git LFS, RealityScan 2.2, Postshot(Studio), XGRIDS LCC4Unreal. 로컬 Claude Code 세션 준비(D-006) | 👤 | UE 에디터 실행, C++ 빌드 성공 |

...
golmok-splat clean D:\golmok_recon\<ID>\splat_crop.ply --out $Z\splat.ply
...
s.game_scripts(paths=("walk_01",), tags=("a","b","c","ac"), presets=("clear_noon",), res=(2560, 1440))   # 두 번째 스크립트는 덮어쓰므로 첫 실행 뒤에
```

...
| WP-05 | UE C++ 2: 포털·조명·디버그 | 🔵 진행 중 | session_01W4S1qYJPhQaziYbJMvAXMo (Fable 5.1 ultracode, 검증 Opus) | 시작 2026-09-25. 설계 패널 → 구현(Lighting→Portals→Debug→Player) → 적대적 리뷰 → 런북 `runbooks/pc-verify-wp05.md` |
...
| V-03 | WP-04/05 빌드·PIE 검증 | ⚪ 대기 | WP-04 런북 준비됨(`runbooks/pc-verify-wp04.md`); WP-05 뒤 함께 실행 |
